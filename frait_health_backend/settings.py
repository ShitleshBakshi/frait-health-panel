...
class Settings(BaseSettings):
    ...
    azure_tenant_id: str = "bb5628b8-e328-4082-a856-433c9edc8fae"  # Azure AD tenant ID
    azure_client_id: str = "a5056d37-4bcd-4f21-9227-83d482c159ef"  # Azure AD client ID (application ID)
    azure_client_secret: str = "GjL8Q-SnVRg_H_gBw~SroTPXR5jxc5s0hOpWXa.L"  # Azure AD client secret
    #azure_redirect_uri: str = "http://pthb-efrait.cymru.nhs.uk/callback"  # Redirect URI after authentication
    azure_redirect_uri: str = "https://pthb-efrait-test.cymru.nhs.uk/callback"
