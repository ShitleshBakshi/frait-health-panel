...
class MSALAuthHandler:
    ...
    def extract_role_from_claims(cls, claims: Dict[str, Any]) -> Optional[str]:
        ...
        print(
            f"WARNING: No valid role found for user. Roles: {roles}, Groups: {groups}")
...
def generate_auth_url(redirect_uri: str, state: Optional[str] = None,
...
async def get_user_from_token(token_data: Dict[str, Any], user_dao: UserDAO) -> Dict[
    str, Any]:
    """
