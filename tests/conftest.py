...
from frait_health_backend.db.utils import create_database, drop_database
...
from frait_health_backend.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    from frait_health_backend.db.models import load_all_models
